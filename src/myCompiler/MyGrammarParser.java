...
public class MyGrammarParser extends Parser {
	...
	public final MyGrammarParser.story_return story() throws RecognitionException {
		...
		LinkedList<Token> chosen_stories =null;
	...
	// $ANTLR start "choose"
	// C:\\Users\\gianl\\OneDrive\\Desktop\\Unibg\\Magistrale\\Linguaggi formali e compilatori\\Progetto\\eclipse-workspace\\ProgettoCompilatori\\src\\MyGrammar.g:155:1: choose returns [LinkedList<Token> stories] : LB CHOOSE list_stories= choose_key_value RB ;
	public final LinkedList<Token> choose() throws RecognitionException {
		LinkedList<Token> stories = null;


		LinkedList<Token> list_stories =null;
	...
	// C:\\Users\\gianl\\OneDrive\\Desktop\\Unibg\\Magistrale\\Linguaggi formali e compilatori\\Progetto\\eclipse-workspace\\ProgettoCompilatori\\src\\MyGrammar.g:163:1: choose_key_value returns [LinkedList<Token> stories] : STRING_VALUE COL story_name_1= STORY_NAME ( COMMA STRING_VALUE COL story_name_n= STORY_NAME )* ;
	public final LinkedList<Token> choose_key_value() throws RecognitionException {
		LinkedList<Token> stories = null;
		...
		try {
			// C:\\Users\\gianl\\OneDrive\\Desktop\\Unibg\\Magistrale\\Linguaggi formali e compilatori\\Progetto\\eclipse-workspace\\ProgettoCompilatori\\src\\MyGrammar.g:164:2: ( STRING_VALUE COL story_name_1= STORY_NAME ( COMMA STRING_VALUE COL story_name_n= STORY_NAME )* )
			// C:\\Users\\gianl\\OneDrive\\Desktop\\Unibg\\Magistrale\\Linguaggi formali e compilatori\\Progetto\\eclipse-workspace\\ProgettoCompilatori\\src\\MyGrammar.g:165:3: STRING_VALUE COL story_name_1= STORY_NAME ( COMMA STRING_VALUE COL story_name_n= STORY_NAME )*
			{
			match(input,STRING_VALUE,FOLLOW_STRING_VALUE_in_choose_key_value475); 
			match(input,COL,FOLLOW_COL_in_choose_key_value477); 
			story_name_1=(Token)match(input,STORY_NAME,FOLLOW_STORY_NAME_in_choose_key_value483); 
			sem.insertChosenStory(story_name_1);
			// C:\\Users\\gianl\\OneDrive\\Desktop\\Unibg\\Magistrale\\Linguaggi formali e compilatori\\Progetto\\eclipse-workspace\\ProgettoCompilatori\\src\\MyGrammar.g:166:3: ( COMMA STRING_VALUE COL story_name_n= STORY_NAME )*
			loop10:
			while (true) {
				int alt10=2;
				...
				switch (alt10) {
				case 1 :
					// C:\\Users\\gianl\\OneDrive\\Desktop\\Unibg\\Magistrale\\Linguaggi formali e compilatori\\Progetto\\eclipse-workspace\\ProgettoCompilatori\\src\\MyGrammar.g:167:3: COMMA STRING_VALUE COL story_name_n= STORY_NAME
					{
					match(input,COMMA,FOLLOW_COMMA_in_choose_key_value493); 
					match(input,STRING_VALUE,FOLLOW_STRING_VALUE_in_choose_key_value495); 
					match(input,COL,FOLLOW_COL_in_choose_key_value497); 
					story_name_n=(Token)match(input,STORY_NAME,FOLLOW_STORY_NAME_in_choose_key_value501); 
	...
	public static final BitSet FOLLOW_STRING_VALUE_in_choose_key_value475 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_COL_in_choose_key_value477 = new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet FOLLOW_STORY_NAME_in_choose_key_value483 = new BitSet(new long[]{0x0000000000000802L});
	public static final BitSet FOLLOW_COMMA_in_choose_key_value493 = new BitSet(new long[]{0x0000000020000000L});
	public static final BitSet FOLLOW_STRING_VALUE_in_choose_key_value495 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_COL_in_choose_key_value497 = new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet FOLLOW_STORY_NAME_in_choose_key_value501 = new BitSet(new long[]{0x0000000000000802L});
}
